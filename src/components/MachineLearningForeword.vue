  ...
  <div class="animate__animated animate__fadeIn root">
    <body class="typora-export os-windows">
      <div id="write" class="">
        ...
        <p>
          <span
            >1.每道题对应一个文件夹，规范命名为“题目名称+姓名+学号”(中间用下划线_隔开)。若一道题有基础题与进阶题，在这道题的文件夹中建立两个子文件夹，分别命名为“题目名称+(基础/进阶)+姓名+学号”(中间用下划线隔开)。若基础题/进阶题有多道，每道题建立一个文件夹，命名为“题目名称+(基础/进阶)+1/2/3/4/5+姓名+学号”(中间用下划线隔开)。</span
          >
        </p>
        <p>
          <span
            >2.每道题的最小文件夹中应包含两个子项目文件：(分别为.py和PDF，命名任意，能区分即可；</span
        ...
        <p>
          <span
            >4.每位机器学习方向同学发送压缩包后，请给机器学习方向-陈昊(招新群有喔)发一条信息提示一下，以免未能及时查看QQ邮箱消息。</span
          >
        </p>
        <p>
          <span
            >5.对于各位大二的同学，由于工作室的机器学习方向大二同学比较多，同时大一很多同学对机器学习也很感兴趣，所以，机器学习方向预计只向大二招一位同学，难度较大，请慎重考虑。对此，我们深表歉意🥺！</span
          >
        </p>
      </div>
    </body>
